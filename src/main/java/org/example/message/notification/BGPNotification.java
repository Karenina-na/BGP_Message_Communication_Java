...
public class BGPNotification implements BGPPkt {
    ...
    private final int major_error_code;
    private final int minor_error_code;

    public BGPNotification(int majorErrorCode, int minorErrorCode) {
    ...
    public byte[] build_packet() {
        ...
        * */
        ...
        packet[18] = (byte) 0x03;
        // major error code
        packet[19] = (byte) major_error_code;
        // minor error code
        packet[20] = (byte) minor_error_code;
